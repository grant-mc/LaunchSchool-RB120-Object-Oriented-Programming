...
module Mailing
  ...
  def send_mail(destination, mail)
    "Send_mailing #{mail} from #{name} to: #{destination}"
    # Omitting the actual send_mailing.
  end
end
...
# => undefined method `860 Blackbird Ln.' for #<PostalService:0x00005571b4aaebe8> (NoMet